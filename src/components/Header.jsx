  ...
  return (
    <header className="flex items-center justify-between p-4 border-b bg-background">
      ...
      <nav className="flex items-center gap-4">
        ...
        <NavLink to="/features" className="text-muted-foreground hover:text-foreground">Features</NavLink>
        <NavLink to="/pricing" className="text-muted-foreground hover:text-foreground">Pricing</NavLink>
